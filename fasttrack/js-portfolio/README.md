...
---
- [y] Resume present and available for download
- [y] Routing either between pages || single scrolling page (using anchors or a some type of navigation)
- [y] Work || Project section with project descriptions and links to Github
- [y] Working links to Github projects or deployed projects
- [y] About section. (Summary can be pulled from your TYS)
- [ ] Contact section with form for visitors to send email
- [y] At least (1) CSS animation existing anywhere on the site
- [y] Github API specific data - Object structure below
- [y] ----------------------------
- [y] Profile picture present, pulled from Github via Github's API
- [y] Bio underneath profile picture, pulled from Github via Github's API
